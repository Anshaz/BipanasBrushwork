...
export const deleteComment = async () => {
  throw new Error('Delete disabled (Firebase removed)');
};

// Likes
export const likeArtwork = async () => {
  throw new Error('Likes disabled (Firebase removed)');
};
export const checkUserLike = async () => false;
export const getLikeCount = async () => 0;

// Optional exports used elsewhere
export const getAllLikes = async () => [];
